      ...
      <Footer className="layout-footer">
        <div className="layout-footer-content">
          <ul className="layout-footer-shortcut">
            <li>
              <span className="layout-footer-shortcut-item">브랜드 스토리</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">회사소개</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">채용정보</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">이용약관</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">개인정보처리방침</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">공지사항</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">고객센터</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">고객의소리</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">전문가등록</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">사업자 구매회원</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">제휴/광고 문의</span>
            </li>
            <li>
              <span className="layout-footer-shortcut-item">입점신청 문의</span>
            </li>
          </ul>
