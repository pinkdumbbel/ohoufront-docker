...
import { watchUnsplach as changePassword_watchUnsplach } from '@/pages/member/changePassword/state/saga';

export const rootSagaMember = [
  login_watchUnsplach(),
  signUp_watchUnsplach(),
  myPage_watchUnsplach(),
  changePassword_watchUnsplach(),
];
